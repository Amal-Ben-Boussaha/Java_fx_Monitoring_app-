...
public class Frmcal2wiController implements Initializable {
   ...
   private ResultSet rs;
    ...
    public void setEcom(int idwi2)
     {
        Query q = em.createQuery("SELECT w FROM Wi2 w WHERE w.idwi2 = :idwi2");
        q.setParameter("idwi2", new Integer(idwi2));
        wi2 = (Wi2) q.getSingleResult();
        jour_txt.setText(wi2.getJourWi());
        date_txt.setText(wi2.getDateWi());
        matieres_txt.setText(wi2.getMatieresWi());
        horaire_txt.setText(wi2.getHoraireWi());
        duree_txt.setText(wi2.getDureeWi());
        salle_txt.setText(wi2.getSalleWi());
        editmode = true;
    ...
    private void enregistrer(ActionEvent event) {
        ...
        {
            wi2.setJourWi(jour_txt.getText());
            wi2.setDateWi(date_txt.getText());
            wi2.setMatieresWi(matieres_txt.getText());
            wi2.setHoraireWi(horaire_txt.getText());
            wi2.setDureeWi(duree_txt.getText());
            wi2.setSalleWi(salle_txt.getText());
...
{ String mStr = matieres_txt.getText().replace( "'" , "''" );
   try{
            String q1 = "SELECT examen FROM mati where classe LIKE '%2WI%'  AND examen  LIKE '"+mStr+"%' ";
...
try{
            String q1 = "SELECT matieres_wi FROM wi2 where matieres_wi like '%"+mStr+"%'";
                   pst = connection.prepareStatement(q1);
...
{   
try{
            String q1 = "SELECT horaire_wi, date_wi FROM wi2 where date_wi='"+date_txt.getText()+"' and horaire_wi ='"+horaire_txt.getText()+"'";
                   pst = connection.prepareStatement(q1);

...
public class Frmcal1mecomController implements Initializable {
   ...
   private ResultSet rs;
    ...
    public void setEcom(int idMecom1)
     {
        Query q = em.createQuery("SELECT m FROM Mecom1 m WHERE m.idMecom1 = :idMecom1");
        q.setParameter("idMecom1", new Integer(idMecom1));
        mecom1 = (Mecom1) q.getSingleResult();
        jour_txt.setText(mecom1.getJour());
        date_txt.setText(mecom1.getDate());
        matieres_txt.setText(mecom1.getMatieres());
        horaire_txt.setText(mecom1.getHoraire());
        duree_txt.setText(mecom1.getDuree());
        salle_txt.setText(mecom1.getSalle());
        editmode = true;
    ...
    private void enregistrer(ActionEvent event) {
        ...
        {
            mecom1.setJour(jour_txt.getText());
            mecom1.setDate(date_txt.getText());
            mecom1.setMatieres(matieres_txt.getText());
            mecom1.setHoraire(horaire_txt.getText());
            mecom1.setDuree(duree_txt.getText());
            mecom1.setSalle(salle_txt.getText());
...
{ String mStr = matieres_txt.getText().replace( "'" , "''" );
   try{
            String q1 = "SELECT examen FROM mati where classe LIKE '%1MECOM%'  AND examen  LIKE '"+mStr+"%' ";
...
try{
            String q1 = "SELECT matieres FROM mecom1 where matieres like '%"+mStr+"%'";
                   pst = connection.prepareStatement(q1);
...
{   
try{
            String q1 = "SELECT horaire, date FROM mecom1 where date='"+date_txt.getText()+"' and horaire ='"+horaire_txt.getText()+"'";
                   pst = connection.prepareStatement(q1);

...
public class Tsi3fx {
    ...
    private SimpleIntegerProperty idtsi3;
    private SimpleStringProperty jourTsi;
    private SimpleStringProperty dateTsi;
    private SimpleStringProperty matiersTsi;
    ...
    public Tsi3fx(Integer idtsi3) {
        this.idtsi3 =new SimpleIntegerProperty (idtsi3);
    }

    public Tsi3fx(Integer idtsi3, String jourTsi, String dateTsi, String matiersTsi, String horaireTsi, String dureeTsi, String groupe1Tsi, String salleG1Tsi, String groupe2Tsi, String salleG2Tsi) {
        this.idtsi3 = new SimpleIntegerProperty ( idtsi3);
        this.jourTsi =new SimpleStringProperty ( jourTsi);
        this.dateTsi =new SimpleStringProperty (  dateTsi);
        this.matiersTsi =new SimpleStringProperty (  matiersTsi);
    ...
    public SimpleIntegerProperty getIdtsi3Property() {
        return idtsi3;
    }
    ...
    public String getMatiersTsi() {
        return matiersTsi.get();
    }
    public SimpleStringProperty getMatiersTsiProperty() {
        return matiersTsi;
    }

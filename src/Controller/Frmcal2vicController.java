...
public class Frmcal2vicController implements Initializable {
   ...
   private ResultSet rs;
    ...
    public void setEcom(int idvic2)
     {
        Query q = em.createQuery("SELECT v FROM Vic2 v WHERE v.idvic2 = :idvic2");
        q.setParameter("idvic2", new Integer(idvic2));
        vic2 = (Vic2) q.getSingleResult();
        jour_txt.setText(vic2.getJourVic());
        date_txt.setText(vic2.getDateVic());
        matieres_txt.setText(vic2.getMatieresVic());
        horaire_txt.setText(vic2.getHoraireVic());
        duree_txt.setText(vic2.getDureeVic());
        salle_txt.setText(vic2.getSalleVic());
        editmode = true;
    ...
    private void enregistrer(ActionEvent event) {
        ...
        {
            vic2.setJourVic(jour_txt.getText());
            vic2.setDateVic(date_txt.getText());
            vic2.setMatieresVic(matieres_txt.getText());
            vic2.setHoraireVic(horaire_txt.getText());
            vic2.setDureeVic(duree_txt.getText());
            vic2.setSalleVic(salle_txt.getText());
...
{ String mStr = matieres_txt.getText().replace( "'" , "''" );
   try{
            String q1 = "SELECT examen FROM mati where classe LIKE '%2VIC%'  AND examen  LIKE '"+mStr+"%' ";
...
try{
            String q1 = "SELECT matieres_vic FROM vic2 where matieres_vic like '%"+mStr+"%'";
                   pst = connection.prepareStatement(q1);
...
{   
try{
            String q1 = "SELECT horaire_vic, date_vic FROM vic2 where date_vic='"+date_txt.getText()+"' and horaire_vic ='"+horaire_txt.getText()+"'";
                   pst = connection.prepareStatement(q1);
